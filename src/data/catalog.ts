...
export const screensCatalog: CatalogItem[] = [
  { id: 'scr-001', sku: 'SCR-001', number: '001', name: 'DARK CITY', price: 3.99, variant: 'mobile7' },
  { id: 'scr-002', sku: 'SCR-002', number: '002', name: 'STATIC', price: 3.99, variant: 'desktop7' },
  ...
  { id: 'scr-005', sku: 'SCR-005', number: '005', name: 'SMOKE', price: 3.99, variant: 'mobile7' },
...
export const soundCatalog: CatalogItem[] = [
  { id: 'snd-001', sku: 'SND-001', number: '001', name: 'NOCTURNE', price: 5.0, variant: 'single' },
